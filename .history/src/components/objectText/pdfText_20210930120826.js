  ...
  pdfText_EN: [
    {
     ...
     },
     {
      ...
      listvedtægter:["Choice of conductor","Report of the Management Board", "Presentation of annual report signed by the Auditor and the Board of Directors for approval", "Submission of operating/liquidity budget for approval and decision on the amount of on-account contributions and deposits for the coming year", "Proposal from the Management Board", "Members' proposals", "Election of board members and alternates, if any", "Administrator selection"],
     },
     {
