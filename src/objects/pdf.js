...
export var pdfList = {
  pdfs: [
    ...
    },
    {
      ...
      text: pdfstexts[2].Text,
      header: pdfstexts[2].header
    },
    {
      name: "Resume2021",
      embedURL:
      ...
      text: pdfstexts[3].Text,
      header: pdfstexts[3].header
    },
    {
      name: "Resume2020",
      embedURL:
    ...
    },
    {
      ...
      text: pdfstexts[4].Text,
      header: pdfstexts[4].header
    },
    {
      name: "Budget2021",
      embedURL:
      ...
      text: pdfstexts[5].Text,
      header: pdfstexts[5].header
    },
    {
      name: "Budget2020",
      embedURL:
    ...
    },
    {
      ...
      text: pdfstexts[6].Text,
      header: pdfstexts[6].header
    },
  ],
};
